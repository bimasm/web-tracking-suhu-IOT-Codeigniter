	...
	<div class="row">
		...
		<div class="col-xl-8 mb-5 mb-xl-0">
			...
			<div class="text-right">
				<a href="<?php echo base_url(); ?>admin/add_channels" class="btn btn-sm btn-primary"style="background-color: white;
			...
			<div class="card-header" style="border-radius: 5px">
				<div class="row align-items-center">
					<div class="col">
						<p class="mb-0" style="text-align: center;">Non Tracking</p>
			...
			<div class="card-header" style="border-radius: 5px">
				<div class="row align-items-center">
					<div class="col">
						<p class="mb-0" style="text-align: center;">Tracking</p>
						<p class="mb-0">Channels ID : 1111</p>
					</div>
					<div class="col text-right">
